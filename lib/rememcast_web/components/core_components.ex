defmodule RememcastWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RememcastWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RememcastWeb.Gettext, "errors", msg, opts)
    end
  end
